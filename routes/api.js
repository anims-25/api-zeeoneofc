...
router.get('/find', async (req, res, next) => {
    ...
    if (apikey != 'sssrrryyyzxzxzx') return res.json(loghandler.invalidKey)
...
router.get('/tiktod', async (req, res, next) => {
	...
	if(!apikeyInput) return res.json(loghandler.notparam)
	if(apikeyInput != 'sssrrryyyzxzxzx') return res.json(loghandler.invalidKey)
